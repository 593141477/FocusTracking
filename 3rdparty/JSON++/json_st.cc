...
Value::Value(string&& s) : string_v((s)), type_t(STRING) { }

Value::Value(Object&& o) : object_v((o)), type_t(OBJECT) { }

Value::Value(Array&& o) : array_v((o)), type_t(ARRAY) { }
...
Object::Object(Object&& o) : _object((o._object)) { }
...
Array::Array(Array&& a) : _array((a._array)) { }
